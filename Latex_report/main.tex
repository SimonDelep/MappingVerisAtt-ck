...
Trois backends de décision sont disponibles après l'étape de retrieval.
...
rejeté. Les backends \texttt{local\_llm} et \texttt{llm} (Azure)
permettraient, eux, de confier au modèle le choix final parmi les
candidats récupérés, mais ils n'ont pas été utilisés pour les résultats
...
Clarifier le fonctionnement des retrieval 
Utiliser 3 LLM différents avec les clés open api 
Venir faire les tests sur les 3 LLM différents et voir les résultats
